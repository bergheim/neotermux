...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME','UP','END','PGUP'], ['TAB','CTRL',{key: 'ALT', popup: 'NEOTERMUX_INPUT_MODE'},'LEFT','DOWN','RIGHT','PGDN']]"; // Double row
